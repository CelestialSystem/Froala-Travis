...
if [ "$command" = "deploy" ]; then
	...
	git clone https://github.com/harasunu-narayan/ionic_sample_froala
	git clone https://github.com/froala/wysiwyg-editor-java-sdk.git
	...
	cp ionic_Dockerfile ionic_sample_froala/
	cp java_Dockerfile wysiwyg-editor-java-sdk
